...
> This directory is the public repository contract for PCssak Gongyu `v0.3.4`
...
Version `0.3.4` is **Free Early Access**; this describes product maturity and
...
[official v0.3.4 release](https://github.com/pcssakinc/pcssak-gongyu-releases/releases/tag/v0.3.4)
...
**Users on 0.2.0, 0.2.1, 0.2.2, 0.2.3, 0.2.4, 0.2.5, 0.2.6, 0.2.7, 0.2.8, 0.3.2, 0.3.3, or an unpublished 0.2.9, 0.3.0 or 0.3.1 build with valid legal-consent records can check for 0.3.4 after its verified publication in the app,
...
For 0.1.1 through 0.3.3, do not uninstall first or delete settings, sharing records,
...
See the [release notes](docs/RELEASE-NOTES-v0.3.4.md) for details.
...
- `PCssak-Gongyu-0.3.4-Windows-x64-Setup.exe`
...
```powershell
Get-FileHash -Algorithm SHA256 '.\PCssak-Gongyu-0.3.4-Windows-x64-Setup.exe'
```

The release also contains `PCssak-Gongyu-0.3.4-Windows-x64-Setup.exe.sig`.
