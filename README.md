...
> This directory is the public repository contract for PCssak Gongyu `v0.2.6`
...
Version `0.2.6` is **Free Early Access**; this describes product maturity and
does not promise that future versions will remain free.

## Official download and Latest update

Use only the
[official v0.2.6 release](https://github.com/pcssakinc/pcssak-gongyu-releases/releases/tag/v0.2.6)
...
**Users on 0.2.0, 0.2.1, 0.2.2, 0.2.3, 0.2.4, or 0.2.5 with valid legal-consent records can check for 0.2.6 in the app,
...
For 0.1.1 through 0.2.5, do not uninstall first or delete settings, sharing records,
...
See the [release notes](docs/RELEASE-NOTES-v0.2.6.md) for details.
...
- `PCssak-Gongyu-0.2.6-Windows-x64-Setup.exe`
...
```powershell
Get-FileHash -Algorithm SHA256 '.\PCssak-Gongyu-0.2.6-Windows-x64-Setup.exe'
```

The release also contains `PCssak-Gongyu-0.2.6-Windows-x64-Setup.exe.sig`.
