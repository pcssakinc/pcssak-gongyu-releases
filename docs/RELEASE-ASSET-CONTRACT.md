...
## 0.3.2 공개 준비 후보의 명명 범위

현재 개발 후보는 0.3.2이며 개발 회귀를 통과했다. 최종 소스·공개 검증은 별도 진행한다. 현재 공개 최신판 0.2.8과
비공개 0.2.9·0.3.0·0.3.1의 기록을 구분한다. 기존 키의 두 서명·정확한 아홉 자산·
최종 소스 및 공개 후 검증이 끝나기 전에는 공개 성공으로 표시하지 않는다.
